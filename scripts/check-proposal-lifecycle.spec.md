...
`scripts/check-proposal-lifecycle.ts` proves the deterministic agent proposal workflow against real Fastify routes and an isolated SQLite-backed `DATA_DIR`.
